...
;BEGIN ALIAS PROPERTY RRDocksMarker
;ALIAS PROPERTY TYPE ReferenceAlias
...
;BEGIN ALIAS PROPERTY WreckageHajMarker
;ALIAS PROPERTY TYPE ReferenceAlias
ReferenceAlias Property Alias_WreckageHajMarker Auto
;END ALIAS PROPERTY
...
Alias_Haj.GetActorRef().AddItem(Alias_ZirathJournal.GetRef())
HajAndCatchesScene.Start()
;END CODE
EndFunction
;END FRAGMENT
...
Faction Property ZirathFaction  Auto  

Scene Property HajAndCatchesScene  Auto  
